...
export const projects: Project[] = [
	...
	},
	{
		...
		outcome:
			'Delivered a polished user experience that effectively communicated the premium offering of Classico and captured early user interest through the waitlist funnel.',
		goals: [
